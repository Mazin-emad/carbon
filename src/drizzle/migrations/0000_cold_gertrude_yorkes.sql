...
CREATE TABLE "course_products" (
	...
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "course_products_id_productId_pk" PRIMARY KEY("id","productId")
);
--> statement-breakpoint
...
ALTER TABLE "course_products" ADD CONSTRAINT "course_products_id_courses_id_fk" FOREIGN KEY ("id") REFERENCES "public"."courses"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
